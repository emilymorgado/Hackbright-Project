...
# # change yellow upload_folder if fail
...
#     # currently, action is to nowhere
...
# app.add_url_rule('/uploaded_file/<filename>', 'uploaded_file',
#                  build_only=True)
